...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div>
            ...
            <br>
            <input type="text" name="taxpayer_registry" id="taxpayer_registry" 
        ...
        <div>
            ...
            <br>
            <input type="text" name="card_number" id="card_number" require
            maxlength="16">
        </div>
        <br>
        <div>
        ...
        <div>
            ...
            <br>
            <input type="text" name="cvv" id="cvv" require
            maxlength="3">
        </div>
        <br>
        <div>
